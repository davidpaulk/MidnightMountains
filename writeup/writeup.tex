...
\begin{figure}[H]
\begin{center}
\fbox{\includegraphics[width=0.54\textwidth,height=\textheight,keepaspectratio]{start_screen}}
\fbox{\includegraphics[width=0.25\textwidth,height=\textheight,keepaspectratio]{end_screen}}
